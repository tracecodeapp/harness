          ...
          files: [
            ...
            },
            {
              ...
              contents: [
                ...
                'var inheritedPipe = TraceKernel.KernelPipe.Create();',
                'var mappedWriteEnd = inheritedPipe.WriteEnd.DuplicateTo(20);',
                'mappedWriteEnd.CloseOnExec = true;',
                'bool descriptorFlags = mappedWriteEnd.CloseOnExec && !mappedWriteEnd.Inheritable;',
