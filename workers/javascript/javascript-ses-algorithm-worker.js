...
function learnerFactorySource(source, code) {
  return `(async () => {
"use strict";
...
function compileLearnerFactory(compartment, source, sanitizedCode) {
...
async function executeCase(program, inputs) {
      ...
      void (async () => {
        switch (request.type) {
          ...
          case "prepare": {
            ...
            let validatedLearnerFactorySource;
            try {
