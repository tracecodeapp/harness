var TraceCodeJavaScriptLibraries = (() => {
  ...
  // node_modules/.pnpm/@datastructures-js+binary-search-tree@5.4.0/node_modules/@datastructures-js/binary-search-tree/src/binarySearchTreeNode.js
  var require_binarySearchTreeNode = __commonJS({
    "node_modules/.pnpm/@datastructures-js+binary-search-tree@5.4.0/node_modules/@datastructures-js/binary-search-tree/src/binarySearchTreeNode.js"(exports) {
      var BinarySearchTreeNode = class _BinarySearchTreeNode {
        constructor(value) {
          this._value = value;
          this._left = null;
          this._right = null;
         ...
         */
        setLeft(left) {
          if (left && !(left instanceof _BinarySearchTreeNode)) {
         ...
         */
        hasLeft() {
          return this._left instanceof _BinarySearchTreeNode;
        }
        /**
         * @public
         ...
         */
        setRight(right) {
          if (right && !(right instanceof _BinarySearchTreeNode)) {
         ...
         */
        hasRight() {
          return this._right instanceof _BinarySearchTreeNode;
        }
        /**
         * @public
         ...
         */
        setParent(parent) {
          if (parent && !(parent instanceof _BinarySearchTreeNode)) {
         ...
         */
        hasParent() {
          return this._parent instanceof _BinarySearchTreeNode;
        }
        /**
         * @public
         * @return {boolean}
  ...
  // node_modules/.pnpm/@datastructures-js+binary-search-tree@5.4.0/node_modules/@datastructures-js/binary-search-tree/src/binarySearchTree.js
  var require_binarySearchTree = __commonJS({
    "node_modules/.pnpm/@datastructures-js+binary-search-tree@5.4.0/node_modules/@datastructures-js/binary-search-tree/src/binarySearchTree.js"(exports) {
      ...
      var BinarySearchTree = class {
        ...
        traverseInOrderIterative(cb, abortCb) {
          ...
          let current = this._root;
          const stack2 = [];
          while (current !== null || stack2.length > 0) {
            while (current !== null) {
              stack2.push(current);
              current = current.getLeft();
            }
  ...
  // node_modules/.pnpm/@datastructures-js+binary-search-tree@5.4.0/node_modules/@datastructures-js/binary-search-tree/src/avlTreeNode.js
  var require_avlTreeNode = __commonJS({
    "node_modules/.pnpm/@datastructures-js+binary-search-tree@5.4.0/node_modules/@datastructures-js/binary-search-tree/src/avlTreeNode.js"(exports) {
      var defaultCompare = (a, b) => {
        if (a === b) return 0;
        return a > b ? 1 : -1;
      };
      var AvlTreeNode = class _AvlTreeNode {
         ...
         */
        setLeft(left) {
          if (left && !(left instanceof _AvlTreeNode)) {
         ...
         */
        hasLeft() {
          return this._left instanceof _AvlTreeNode;
        }
        /**
         * @public
         ...
         */
        setRight(right) {
          if (right && !(right instanceof _AvlTreeNode)) {
         ...
         */
        hasRight() {
          return this._right instanceof _AvlTreeNode;
        }
        /**
         * @public
         ...
         */
        setParent(parent) {
          if (parent && !(parent instanceof _AvlTreeNode)) {
         ...
         */
        hasParent() {
          return this._parent instanceof _AvlTreeNode;
        }
        /**
         * @public
         * @return {boolean}
  ...
  // node_modules/.pnpm/@datastructures-js+binary-search-tree@5.4.0/node_modules/@datastructures-js/binary-search-tree/src/avlTree.js
  var require_avlTree = __commonJS({
    "node_modules/.pnpm/@datastructures-js+binary-search-tree@5.4.0/node_modules/@datastructures-js/binary-search-tree/src/avlTree.js"(exports) {
  ...
  // node_modules/.pnpm/@datastructures-js+binary-search-tree@5.4.0/node_modules/@datastructures-js/binary-search-tree/index.js
  var require_binary_search_tree = __commonJS({
    "node_modules/.pnpm/@datastructures-js+binary-search-tree@5.4.0/node_modules/@datastructures-js/binary-search-tree/index.js"(exports, module) {
      var { BinarySearchTree } = require_binarySearchTree();
      var { BinarySearchTreeNode } = require_binarySearchTreeNode();
  ...
  // node_modules/.pnpm/@datastructures-js+deque@1.0.8/node_modules/@datastructures-js/deque/src/deque.js
  var require_deque = __commonJS({
    "node_modules/.pnpm/@datastructures-js+deque@1.0.8/node_modules/@datastructures-js/deque/src/deque.js"(exports) {
  ...
  // node_modules/.pnpm/@datastructures-js+deque@1.0.8/node_modules/@datastructures-js/deque/index.js
  var require_deque2 = __commonJS({
    "node_modules/.pnpm/@datastructures-js+deque@1.0.8/node_modules/@datastructures-js/deque/index.js"(exports) {
      var { Deque: Deque2 } = require_deque();
      exports.Deque = Deque2;
    }
  });

  // node_modules/.pnpm/@datastructures-js+queue@3.1.4/node_modules/@datastructures-js/queue/src/queue.js
  var require_queue = __commonJS({
    "node_modules/.pnpm/@datastructures-js+queue@3.1.4/node_modules/@datastructures-js/queue/src/queue.js"(exports, module) {
      var Queue2 = class _Queue {
        /**
         * Creates a queue.
         * @param {array} [elements]
         */
  ...
  // node_modules/.pnpm/@datastructures-js+queue@3.1.4/node_modules/@datastructures-js/queue/index.js
  var require_queue2 = __commonJS({
    "node_modules/.pnpm/@datastructures-js+queue@3.1.4/node_modules/@datastructures-js/queue/index.js"(exports, module) {
      var Queue2 = require_queue();
      module.exports = Queue2;
    }
  });

  // node_modules/.pnpm/@datastructures-js+graph@5.3.1/node_modules/@datastructures-js/graph/src/directedGraph.js
  var require_directedGraph = __commonJS({
    "node_modules/.pnpm/@datastructures-js+graph@5.3.1/node_modules/@datastructures-js/graph/src/directedGraph.js"(exports) {
      var Queue2 = require_queue2();
  ...
  // node_modules/.pnpm/@datastructures-js+graph@5.3.1/node_modules/@datastructures-js/graph/src/graph.js
  var require_graph = __commonJS({
    "node_modules/.pnpm/@datastructures-js+graph@5.3.1/node_modules/@datastructures-js/graph/src/graph.js"(exports) {
  ...
  // node_modules/.pnpm/@datastructures-js+graph@5.3.1/node_modules/@datastructures-js/graph/index.js
  var require_graph2 = __commonJS({
    "node_modules/.pnpm/@datastructures-js+graph@5.3.1/node_modules/@datastructures-js/graph/index.js"(exports) {
  ...
  // node_modules/.pnpm/@datastructures-js+heap@4.3.7/node_modules/@datastructures-js/heap/src/heap.js
  var require_heap = __commonJS({
    "node_modules/.pnpm/@datastructures-js+heap@4.3.7/node_modules/@datastructures-js/heap/src/heap.js"(exports) {
      var Heap2 = class _Heap {
        /**
  ...
  // node_modules/.pnpm/@datastructures-js+heap@4.3.7/node_modules/@datastructures-js/heap/src/minHeap.js
  var require_minHeap = __commonJS({
    "node_modules/.pnpm/@datastructures-js+heap@4.3.7/node_modules/@datastructures-js/heap/src/minHeap.js"(exports) {
      var { Heap: Heap2 } = require_heap();
      var getMinCompare = (getCompareValue) => (a, b) => {
        const aVal = typeof getCompareValue === "function" ? getCompareValue(a) : a;
        const bVal = typeof getCompareValue === "function" ? getCompareValue(b) : b;
        return aVal <= bVal ? -1 : 1;
      };
      var MinHeap2 = class _MinHeap extends Heap2 {
        /**
      ...
      exports.MinHeap = MinHeap2;
    }
  });

  // node_modules/.pnpm/@datastructures-js+heap@4.3.7/node_modules/@datastructures-js/heap/src/maxHeap.js
  var require_maxHeap = __commonJS({
    "node_modules/.pnpm/@datastructures-js+heap@4.3.7/node_modules/@datastructures-js/heap/src/maxHeap.js"(exports) {
      var { Heap: Heap2 } = require_heap();
      ...
      var MaxHeap2 = class _MaxHeap extends Heap2 {
        /**
         * @param {function} [getCompareValue]
         * @param {array} [values]
         */
  ...
  // node_modules/.pnpm/@datastructures-js+heap@4.3.7/node_modules/@datastructures-js/heap/index.js
  var require_heap2 = __commonJS({
    "node_modules/.pnpm/@datastructures-js+heap@4.3.7/node_modules/@datastructures-js/heap/index.js"(exports) {
      var { Heap: Heap2 } = require_heap();
      var { MinHeap: MinHeap2 } = require_minHeap();
      var { MaxHeap: MaxHeap2 } = require_maxHeap();
      exports.Heap = Heap2;
      exports.MinHeap = MinHeap2;
      exports.MaxHeap = MaxHeap2;
    }
  ...
  // node_modules/.pnpm/@datastructures-js+linked-list@6.1.4/node_modules/@datastructures-js/linked-list/src/linkedListNode.js
  var require_linkedListNode = __commonJS({
    "node_modules/.pnpm/@datastructures-js+linked-list@6.1.4/node_modules/@datastructures-js/linked-list/src/linkedListNode.js"(exports) {
      var LinkedListNode2 = class _LinkedListNode {
        /**
         ...
         */
        setNext(next) {
          if (next && !(next instanceof _LinkedListNode)) {
         ...
         */
        hasNext() {
          return this._next instanceof _LinkedListNode;
        }
        /**
         * @public
         * @returns {LinkedListNode}
  ...
  // node_modules/.pnpm/@datastructures-js+linked-list@6.1.4/node_modules/@datastructures-js/linked-list/src/linkedList.js
  var require_linkedList = __commonJS({
    "node_modules/.pnpm/@datastructures-js+linked-list@6.1.4/node_modules/@datastructures-js/linked-list/src/linkedList.js"(exports) {
      var { LinkedListNode: LinkedListNode2 } = require_linkedListNode();
      var LinkedList2 = class _LinkedList {
        constructor() {
          this._head = null;
          this._count = 0;
        }
        ...
        insertFirst(value) {
          let newNode = value;
          if (!(newNode instanceof LinkedListNode2)) {
            newNode = new LinkedListNode2(value);
          }
        ...
        insertLast(value, startingNode) {
          ...
          if (startingNode && !(startingNode instanceof LinkedListNode2)) {
        ...
        removeEach(cb) {
          ...
          let prev = null;
          let current = this._head;
          while (current instanceof LinkedListNode2) {
        ...
        static fromArray(values) {
          ...
          const linkedList2 = new _LinkedList();
          let lastInserted = null;
          values.forEach((value) => {
            lastInserted = linkedList2.insertLast(value, lastInserted);
          });
          return linkedList2;
        }
      };
      exports.LinkedList = LinkedList2;
    }
  });

  // node_modules/.pnpm/@datastructures-js+linked-list@6.1.4/node_modules/@datastructures-js/linked-list/src/doublyLinkedListNode.js
  var require_doublyLinkedListNode = __commonJS({
    "node_modules/.pnpm/@datastructures-js+linked-list@6.1.4/node_modules/@datastructures-js/linked-list/src/doublyLinkedListNode.js"(exports) {
      var DoublyLinkedListNode2 = class _DoublyLinkedListNode {
        /**
         ...
         */
        setNext(next) {
          if (next && !(next instanceof _DoublyLinkedListNode)) {
         ...
         */
        hasNext() {
          return this._next instanceof _DoublyLinkedListNode;
        }
        /**
         * @public
         * @param {DoublyLinkedListNode} [prev]
         ...
         */
        setPrev(prev) {
          if (prev && !(prev instanceof _DoublyLinkedListNode)) {
         ...
         */
        hasPrev() {
          return this._prev instanceof _DoublyLinkedListNode;
        }
        /**
         * @public
         * @returns {DoublyLinkedListNode}
      ...
      exports.DoublyLinkedListNode = DoublyLinkedListNode2;
    }
  });

  // node_modules/.pnpm/@datastructures-js+linked-list@6.1.4/node_modules/@datastructures-js/linked-list/src/doublyLinkedList.js
  var require_doublyLinkedList = __commonJS({
    "node_modules/.pnpm/@datastructures-js+linked-list@6.1.4/node_modules/@datastructures-js/linked-list/src/doublyLinkedList.js"(exports) {
      var { DoublyLinkedListNode: DoublyLinkedListNode2 } = require_doublyLinkedListNode();
      var DoublyLinkedList2 = class _DoublyLinkedList {
        constructor() {
          this._head = null;
          this._tail = null;
          this._count = 0;
        ...
        insertFirst(value) {
          let newNode = value;
          if (!(newNode instanceof DoublyLinkedListNode2)) {
            newNode = new DoublyLinkedListNode2(value);
          }
          if (this.isEmpty()) {
            this._head = newNode;
            this._tail = newNode;
         ...
         */
        remove(node) {
          if (node && !(node instanceof DoublyLinkedListNode2)) {
        ...
        removeEach(cb) {
          ...
          let position = 0;
          let current = this._head;
          while (current instanceof DoublyLinkedListNode2) {
            if (cb(current, position)) {
        ...
        find(cb, startingNode = this._head) {
          ...
          if (startingNode && !(startingNode instanceof DoublyLinkedListNode2)) {
        ...
        filter(cb) {
          ...
          const result = new _DoublyLinkedList();
          this.forEach((node, position) => {
            if (cb(node, position)) {
      ...
      exports.DoublyLinkedList = DoublyLinkedList2;
    }
  });

  // node_modules/.pnpm/@datastructures-js+linked-list@6.1.4/node_modules/@datastructures-js/linked-list/index.js
  var require_linked_list = __commonJS({
    "node_modules/.pnpm/@datastructures-js+linked-list@6.1.4/node_modules/@datastructures-js/linked-list/index.js"(exports, module) {
      var { LinkedListNode: LinkedListNode2 } = require_linkedListNode();
      var { LinkedList: LinkedList2 } = require_linkedList();
      var { DoublyLinkedListNode: DoublyLinkedListNode2 } = require_doublyLinkedListNode();
      var { DoublyLinkedList: DoublyLinkedList2 } = require_doublyLinkedList();
      module.exports = {
        LinkedListNode: LinkedListNode2,
        LinkedList: LinkedList2,
        DoublyLinkedListNode: DoublyLinkedListNode2,
        DoublyLinkedList: DoublyLinkedList2
      };
    }
  });

  // node_modules/.pnpm/@datastructures-js+priority-queue@6.3.5/node_modules/@datastructures-js/priority-queue/src/priorityQueue.js
  var require_priorityQueue = __commonJS({
    "node_modules/.pnpm/@datastructures-js+priority-queue@6.3.5/node_modules/@datastructures-js/priority-queue/src/priorityQueue.js"(exports) {
      var { Heap: Heap2 } = require_heap2();
      var PriorityQueue2 = class {
        ...
        constructor(compare, values) {
          ...
          this._heap = new Heap2(compare, values);
        }
        /**
      ...
      PriorityQueue2.fromArray = function fromArray(values, compare) {
        return new PriorityQueue2(compare, values);
      };
      exports.PriorityQueue = PriorityQueue2;
    }
  });

  // node_modules/.pnpm/@datastructures-js+priority-queue@6.3.5/node_modules/@datastructures-js/priority-queue/src/minPriorityQueue.js
  var require_minPriorityQueue = __commonJS({
    "node_modules/.pnpm/@datastructures-js+priority-queue@6.3.5/node_modules/@datastructures-js/priority-queue/src/minPriorityQueue.js"(exports) {
      var { PriorityQueue: PriorityQueue2 } = require_priorityQueue();
      var MinPriorityQueue2 = class extends PriorityQueue2 {
      ...
      MinPriorityQueue2.fromArray = function fromArray(values, options) {
        return new MinPriorityQueue2(options, values);
      };
      exports.MinPriorityQueue = MinPriorityQueue2;
    }
  });

  // node_modules/.pnpm/@datastructures-js+priority-queue@6.3.5/node_modules/@datastructures-js/priority-queue/src/maxPriorityQueue.js
  var require_maxPriorityQueue = __commonJS({
    "node_modules/.pnpm/@datastructures-js+priority-queue@6.3.5/node_modules/@datastructures-js/priority-queue/src/maxPriorityQueue.js"(exports) {
      var { PriorityQueue: PriorityQueue2 } = require_priorityQueue();
      var MaxPriorityQueue2 = class extends PriorityQueue2 {
        constructor(options, values) {
          if (options && typeof options === "object" && typeof options.compare === "function") {
            const compareFunction = (a, b) => options.compare(a, b) <= 0 ? -1 : 1;
            super(compareFunction, values);
      ...
      MaxPriorityQueue2.fromArray = function fromArray(values, options) {
        return new MaxPriorityQueue2(options, values);
      };
      exports.MaxPriorityQueue = MaxPriorityQueue2;
    }
  });

  // node_modules/.pnpm/@datastructures-js+priority-queue@6.3.5/node_modules/@datastructures-js/priority-queue/index.js
  var require_priority_queue = __commonJS({
    "node_modules/.pnpm/@datastructures-js+priority-queue@6.3.5/node_modules/@datastructures-js/priority-queue/index.js"(exports, module) {
      var { MinPriorityQueue: MinPriorityQueue2 } = require_minPriorityQueue();
      var { MaxPriorityQueue: MaxPriorityQueue2 } = require_maxPriorityQueue();
      var { PriorityQueue: PriorityQueue2 } = require_priorityQueue();
      module.exports = { MinPriorityQueue: MinPriorityQueue2, MaxPriorityQueue: MaxPriorityQueue2, PriorityQueue: PriorityQueue2 };
    }
  });

  // node_modules/.pnpm/@datastructures-js+queue@4.3.0/node_modules/@datastructures-js/queue/src/queue.js
  var require_queue3 = __commonJS({
    "node_modules/.pnpm/@datastructures-js+queue@4.3.0/node_modules/@datastructures-js/queue/src/queue.js"(exports) {
      var Queue2 = class _Queue {
        /**
         * Creates a queue.
         * @param {array} [elements]
  ...
  // node_modules/.pnpm/@datastructures-js+queue@4.3.0/node_modules/@datastructures-js/queue/index.js
  var require_queue4 = __commonJS({
    "node_modules/.pnpm/@datastructures-js+queue@4.3.0/node_modules/@datastructures-js/queue/index.js"(exports) {
      var { Queue: Queue2 } = require_queue3();
      exports.Queue = Queue2;
    }
  });

  // node_modules/.pnpm/@datastructures-js+set@4.2.2/node_modules/@datastructures-js/set/src/enhancedSet.js
  var require_enhancedSet = __commonJS({
    "node_modules/.pnpm/@datastructures-js+set@4.2.2/node_modules/@datastructures-js/set/src/enhancedSet.js"(exports) {
      var EnhancedSet2 = class _EnhancedSet extends Set {
        /**
        ...
        power(m, seprator = "") {
          ...
          if (+m === 0) return new _EnhancedSet();
         ...
         */
        clone() {
          return new _EnhancedSet(this.toArray());
        }
      };
      exports.EnhancedSet = EnhancedSet2;
    }
  });

  // node_modules/.pnpm/@datastructures-js+set@4.2.2/node_modules/@datastructures-js/set/index.js
  var require_set = __commonJS({
    "node_modules/.pnpm/@datastructures-js+set@4.2.2/node_modules/@datastructures-js/set/index.js"(exports) {
      var { EnhancedSet: EnhancedSet2 } = require_enhancedSet();
      exports.EnhancedSet = EnhancedSet2;
    }
  });

  // node_modules/.pnpm/@datastructures-js+stack@3.1.6/node_modules/@datastructures-js/stack/src/stack.js
  var require_stack = __commonJS({
    "node_modules/.pnpm/@datastructures-js+stack@3.1.6/node_modules/@datastructures-js/stack/src/stack.js"(exports) {
      var Stack2 = class _Stack {
         ...
         */
        clone() {
          return new _Stack(this._elements.slice());
        }
        /**
  ...
  // node_modules/.pnpm/@datastructures-js+stack@3.1.6/node_modules/@datastructures-js/stack/index.js
  var require_stack2 = __commonJS({
    "node_modules/.pnpm/@datastructures-js+stack@3.1.6/node_modules/@datastructures-js/stack/index.js"(exports) {
      var { Stack: Stack2 } = require_stack();
      exports.Stack = Stack2;
    }
  });

  // node_modules/.pnpm/@datastructures-js+trie@4.2.3/node_modules/@datastructures-js/trie/src/trieNode.js
  var require_trieNode = __commonJS({
    "node_modules/.pnpm/@datastructures-js+trie@4.2.3/node_modules/@datastructures-js/trie/src/trieNode.js"(exports) {
      var TrieNode = class _TrieNode {
         ...
         */
        addChild(char) {
          const childNode = new _TrieNode(char);
  ...
  // node_modules/.pnpm/@datastructures-js+trie@4.2.3/node_modules/@datastructures-js/trie/src/trie.js
  var require_trie = __commonJS({
    "node_modules/.pnpm/@datastructures-js+trie@4.2.3/node_modules/@datastructures-js/trie/src/trie.js"(exports) {
      ...
      var Trie = class _Trie {
         ...
         */
        static fromArray(values) {
          const trie2 = new _Trie();
          values.forEach((value) => trie2.insert(value));
          return trie2;
        }
      };
      exports.Trie = Trie;
  ...
  // node_modules/.pnpm/@datastructures-js+trie@4.2.3/node_modules/@datastructures-js/trie/index.js
  var require_trie2 = __commonJS({
    "node_modules/.pnpm/@datastructures-js+trie@4.2.3/node_modules/@datastructures-js/trie/index.js"(exports) {
  ...
  var binarySearchTree = __toESM(require_binary_search_tree(), 1);
  var deque = __toESM(require_deque2(), 1);
  var graph = __toESM(require_graph2(), 1);
  var heap = __toESM(require_heap2(), 1);
  var linkedList = __toESM(require_linked_list(), 1);
  var priorityQueue = __toESM(require_priority_queue(), 1);
  var queue = __toESM(require_queue4(), 1);
  var enhancedSet = __toESM(require_set(), 1);
  var stack = __toESM(require_stack2(), 1);
  var trie = __toESM(require_trie2(), 1);
  var modules = {
    lodash: import_lodash.default,
    "lodash.js": import_lodash.default,
  ...
  var previousRequire = typeof scope.require === "function" ? scope.require : null;
  ...
  scope._ = import_lodash.default;
  scope.lodash = import_lodash.default;
