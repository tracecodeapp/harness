...
function augmentJavaProjectFileMutations(source) {
  return String(source ?? '')
    .replace(/\bjava\.nio\.file\.Files\.(readString|readAllBytes|list|newDirectoryStream|exists|notExists|isDirectory|isRegularFile|writeString|write|newOutputStream|newBufferedWriter|newByteChannel|deleteIfExists|delete|copy|move)\s*\(/g, 'tracecode.browser.ProjectEvents.$1(')
    .replace(/(?<![\w.])Files\.(readString|readAllBytes|list|newDirectoryStream|exists|notExists|isDirectory|isRegularFile|writeString|write|newOutputStream|newBufferedWriter|newByteChannel|deleteIfExists|delete|copy|move)\s*\(/g, 'tracecode.browser.ProjectEvents.$1(')
