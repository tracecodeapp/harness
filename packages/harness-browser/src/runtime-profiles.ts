...
const CPP_RUNTIME_PROFILE: LanguageRuntimeProfile = {
  ...
  notes: [
    ...
    'TraceKernel 0.13 project execution maps WASI filesystem descriptors and local BSD sockets to kernel-owned syscalls; standalone clients retain snapshot and structured-HTTP compatibility.',
  ],
};
